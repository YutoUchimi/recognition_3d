...
class DatasetCollectedOnShelfMultiView(object):
    ...
    def __init__(self):
        ...
        self.root = osp.expanduser('~/.ros/bthesis/transparent_objects')
    ...
    def __getitem__(self, i):
        ...
        img = skimage.io.imread(osp.join(data_dir, 'rgb_image.jpg'))
...
def main():
    ...
    out_dir = osp.expanduser('~/.ros/bthesis/transparent_objects_scenes')
